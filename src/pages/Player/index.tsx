...
const demoSongList=[
  ...
  {id: 222, name:'测试',url:'http://localhost:8091/mp3/1897658456.mp3'},
  {id:2233,name:'11',url:'http://localhost:8091/mp3/1903299149.mp3'}
]
...
export default function Palyer() {
  ...
  const handlSong  = (aduio,flag) => {
    ...
    setIsScroll(flag)
    // aduio.onTimeUpdate((params) => {
      // console.log(params,aduio.currentTime,12)
    // })
  }
